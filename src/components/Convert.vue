...
    blocks:[
        {
            name: "Игровые моменты",
            notes: "В данном разделе описываются ситуации, которые могут произойти в игре",
            locuses: [
        {
                    locus_name: "Форс-мажор",
                    locus_notes: "Обстоятельства, которые создают Аватару новые проблемы на пути к достижению поставленной цели.",
                    locus_category: "форс-мажор",
                    locus_backimg: "C_FORCEM_001_",
...
        },
        {
            name: "Гимнастические упражнения",
            notes: "Программа гимнастических упражнений",
            locuses: [
        {
...
        },
        {
            name: "Упражнения на растяжку",
            notes: "Необходимые упражнения на растяжку",
            locuses: [
        {
                    locus_name: "Растяжка",
...
    ]
          ...
          console.log('Blocks Count 2: ' + Object.keys(this.object.blocks).length)

          axios.post('/api/convert-template', {  
                id: this.id,
