<template>
  ...
  >
   ...
   <hr>
    1.1.Настоящее Пользовательское соглашение (далее – Соглашение) относится к сайту Интернет-ресурса «Маршрут Здоровья доктора Горбунова», расположенному 
    по адресу www.medifit.ru, и ко всем соответствующим сайтам, связанным с сайтом
     www.medifit.ru. <br>
    1.2. Сайт Интернет-ресурса «Маршрут Здоровья доктора Горбунова»  (далее – Сайт) является собственностью  Горбунова Валерия Валерьевича<br>
    1.3. Настоящее Соглашение регулирует отношения между Администрацией сайта Интернет-ресурса «Маршрут Здоровья доктора Горбунова» (далее – Администрация сайта) и Пользователем данного Сайта.<br>
    ...
    2.1.1 «Маршрут Здоровья доктора Горбунова» – Интернет-ресурс, расположенный на доменном имени www.medifit.ru, осуществляющий свою деятельность посредством Интернет-ресурса и сопутствующих ему сервисов.<br>
    2.1.2. Интернет-ресурс – сайт, содержащий информацию о Товарах, Продавце, позволяющий осуществить выбор, заказ и (или) приобретение Товара. <br>
    2.1.3. Администрация сайта Интернет-ресурса – уполномоченные сотрудники на управления Сайтом, действующие от имени Горбунова Валерия Валерьевича.<br>
    ...
    •	доступ к электронному контенту на  бесплатной основе, с правом скачивания, просмотра контента;<br>
    •	доступ к средствам поиска и навигации Интернет-ресурса;<br>
    •	предоставление Пользователю возможности размещения сообщений, комментариев, рецензий Пользователей, выставления оценок контенту Интернет-ресурса;<br>
   ...
   <hr>
    ...
    4.1.4. Собирать, анализировать, использовать, делиться (в том числе на платной основе) информацией о Пользователе, содержащейся на Сайте, включая, но не ограничиваясь, информацией о контактных и личных данных Пользователя, информацией о действиях Пользователя на Сайте и.т.д.<br>
    <hr>
    ...
    4.2.3. Задавать любые вопросы, относящиеся к услугам Интернет-ресурса по e-mail: medifit@mail.ru.<br>
    ...
    4.4.6. Использовать Сайт и его Содержание в любых целях, запрещенных законодательством Российской Федерации, а также подстрекать к любой незаконной деятельности или другой деятельности, нарушающей права интернет-ресурса или других лиц.<br>
    4.4.7. Применять знания, полученные в процессе игры, в реальном мире можно только после консультации специалиста. Имеются противопоказания, необходимо проконсультироваться со специалистом.<br>
    ...
    5.12. При добавлении контента на сайт, Пользователь обязуется предоставлять в публичный доступ свои имя и адрес электронной почты. Анонимное размещение материалов на сайте запрещено.<br>
    5.13. Размещение Пользователем материалов и комментариев к материалам на сайте осуществляется после проверки модератором. Модератор вправе отклонить предлагаемый пользователем контент без объяснения причин.<br>
    <hr>
    6.	ОТВЕТСТВЕННОСТЬ
    <hr>
    ...
    6.3. Пользователь самостоятельно несет ответственность за интерпретацию и использование контента (информации), размещенного на Сайте.<br>
    <hr>
    ...
    8.2. Получатель претензии в течение 14 (четырнадцати) календарных дней со дня ее получения, письменно уведомляет заявителя претензии о результатах рассмотрения претензии.<br>
